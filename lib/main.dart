...
final GoRouter _router = GoRouter(
  ...
  routes: [
    ...
    GoRoute(path: '/name-input', builder: (context, state) => const NameInputWidget(),)
    ...
    return MaterialApp.router(
      ...
      theme: ThemeData(
        textTheme: GoogleFonts.nunitoTextTheme(textTheme).copyWith(
          ...
          titleSmall: GoogleFonts.nunito(textStyle: TextStyle(fontSize: 24, fontWeight: FontWeight.w900))
        )
